...
<img src="https://skillicons.dev/icons?i=java,js,ts,react,spring,nodejs,solidity,firebase,wordpress,php,html,css,tailwind,git,github,vscode&theme=dark" />
...
<table>
  <tr>
    ...
    <td width="50%">
      <h3>Blockchain</h3>
      <p>Exploring smart contracts, decentralized verification, Merkle Trees, IPFS, and Polygon-based systems.</p>
    </td>
  </tr>
  <tr>
    <td width="50%">
...
<table>
  <tr>
    <td width="100%">
      ...
      <p>
        <b>Core Features:</b> QR-based verification, IPFS metadata storage, smart contract anchoring, Firebase backend, Merkle Tree batch issuance, and Polygon blockchain integration.
      </p>
    </td>
  </tr>
</table>
